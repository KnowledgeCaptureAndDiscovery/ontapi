...
public class KBAPIJena implements KBAPI {
  ...
  public KBAPIJena(OntSpec spec, Dataset tdbstore) {
    this.spec = spec;
    try {
  ...
  public KBAPIJena(String url, Dataset tdbstore, OntSpec spec) throws Exception{
    this(url, tdbstore, spec, false);
  }
  ...
  public KBAPIJena(String url, Dataset tdbstore, OntSpec spec, boolean load_url_into_store) throws Exception {
    this.url = url;
    this.spec = spec;
  ...
  public void importFrom(KBAPI kb) {
    ...
    OntModel jmodel = japi.ontmodel;    
    ontmodel.addSubModel(jmodel);
    submodels.add(japi);
  }
  ...
  public void copyFrom(KBAPI kb) {
    ...
    KBAPIJena japi = (KBAPIJena) kb;
    StmtIterator statements = japi.ontmodel.listStatements();
  ...
  public void shutdown() {
    /* Abort any transactions and end triple store */
    if(tdbstore != null && tdbstore.isInTransaction()) {
